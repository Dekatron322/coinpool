...
==================================*/    
    ...
    function chart(){
      ...
      var labels = ["Â«BountyÂ»  Marketing", "Team", "Staking and Farming", "Presale and Liquidity", "Community Allocation",];
      var data = [20, 10, 20, 40, 10];
      var bgColor = colors;
      var dataChart = {
        labels: labels,
        datasets: [{
      ...
      var layout2labels = ["20% Marketing", "10% Team", "20% Staking and Farming", "40% Presale and Liquidity", "10% Community Allocation"];
      var layout2data = [20, 10, 20, 40, 10];
      var layout2data2 = [20, 10, 20, 40, 10];
